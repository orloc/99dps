...
var themes = []theme{
	{
		...
		text: "#e7e2d4", dim: "#a89f95", // dim nudged 30% toward text (less faded)
		track: "#2a2620",
	},
	{
		name: "Velious Ice",
		...
		text: "#dce8ee", dim: "#8c9fa9", // dim nudged 30% toward text (less faded)
		track: "#16242c",
	},
	{
		name: "Spirit Crimson",
		...
		text: "#ecdcdc", dim: "#a88f8f", // dim nudged 30% toward text (less faded)
		track: "#2a1818",
	},
}
